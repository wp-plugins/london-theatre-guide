...
#london_events sub {   // credit
	...
	echo "</div></div><p>A very small one-line link/credit will appear underneath the listing.<br>If you appreciate all of the hard work that we put in every day to keep these listings up-to-date, then we'd be grateful if you leave it in place. You can, of course, style it however you wish to match your site.</p></div>";
